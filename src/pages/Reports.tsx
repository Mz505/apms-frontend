...
const Reports: React.FC = () => {
    ...
    try {
      ...
      switch (reportType) {
        ...
        case 'issuance':
          ...
          console.log('Fetched Issuances:', response);
  ...
  const generateIssuanceCSV = (data: any) => {
    ...
    const rows = data.issuances.flatMap((issuance: any) =>
      issuance.issuedMedicines.map((med: any) => [
        `"${med.medicineId?.name || 'Unknown'}"`,
        `"${med.medicineId?.category || 'Unknown'}"`,
